...
{
    public class AutoAcknowledgmentRegister : IRegister
    {
        public RegisterEnum Type { get; } = RegisterEnum.AutoAcknowledgment;
        ...
        private AutoAcknowledgmentRegister() {}

        public AutoAcknowledgmentRegister(bool enableOnPipe0, bool enableOnPipe1, bool enableOnPipe2, bool enableOnPipe3, bool enableOnPipe4, bool enableOnPipe5)
        {
        ...
        public static implicit operator byte(AutoAcknowledgmentRegister input)
        {
            byte output = 0;
        ...
        public static implicit operator AutoAcknowledgmentRegister(byte input)
        {
            var output = new AutoAcknowledgmentRegister
                         {
