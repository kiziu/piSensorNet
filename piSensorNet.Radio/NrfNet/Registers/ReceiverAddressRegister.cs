...
{
    public class ReceiverAddressRegister : IRegister
    {
        public RegisterEnum Type { get; } = RegisterEnum.ReceiverAddress;
        ...
        private ReceiverAddressRegister() {}

        public ReceiverAddressRegister(bool enableOnPipe0, bool enableOnPipe1, bool enableOnPipe2, bool enableOnPipe3, bool enableOnPipe4, bool enableOnPipe5)
        {
        ...
        public static implicit operator byte(ReceiverAddressRegister input)
        {
            byte output = 0;
        ...
        public static implicit operator ReceiverAddressRegister(byte input)
        {
            var output = new ReceiverAddressRegister
                         {
